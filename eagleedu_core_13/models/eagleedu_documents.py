...
#
#     doc_attach_rel = fields.Many2many('eagleedu.documents', 'doc_attachment_id', 'attach_id4', 'doc_id',
#                                       string="Attachment", invisible=1)


class DocumenteduDocumentedu(models.Model):
    _name = 'documentedu.documentedu'
